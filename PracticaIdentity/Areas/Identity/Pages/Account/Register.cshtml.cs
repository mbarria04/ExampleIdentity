...
namespace PracticaIdentity.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// 
            [Required]
            [StringLength(100, ErrorMessage = "El nombre completo debe tener un m ximo de 100 caracteres.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await _emailSender.SendEmailAsync(Input.Email, "Confirmaciòn de correo electr nico",
                    $"Por favor, confirma tu cuenta haciendo <a href='{callbackUrl}'>clic aqu </a>.");
